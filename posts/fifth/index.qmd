...
Pour atteindre notre objectif, nous nous sommes placés dans un cadre paramétrique. Cela nous a offert plus de flexibilité et la possibilité d'explorer tous les cas de figures possibles.
...
Concernant les consommateurs, nous avons quantifié les impacts de ces stratégies sur la *demande individuelle*, sur la *demande indirecte* et sur le *surplus individuel* des consommateurs. Ensuite, nous avons comparé les résultats obtenus dans les 2 cas de figure pour savoir quelle stratégie est la plus optimale, si le monopole décide de les appliquer séparément. Puis, nous avons étudié la situation dans laquelle le monopole donne la possibilité au consommateur de choisir entre les 2 formules.

Pour finir, dans chacun des cas nous avons quantifié l'impact de ces stratégies sur le monopole.
