...
::: {style="text-align:center;"}
[Lire le rapport {{< fa arrow-up-right-from-square >}}](Application d'algorithmes de classification non supervisée sur les bien immobiliers de Saratoga, Californie.pdf){.btn .btn-outline-primary .btn .center role="button"}
:::
