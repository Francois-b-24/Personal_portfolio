...
$TE_i$ désigne l'efficacité technique définie comme le rapport entre la production observée et la production maximale réalisable. $TE = (\frac{y}{y*})$. $TE_i = 1$ montre que la ième entreprise obtient la production maximale réalisable, tandis que $TE_i$ \< 1 fournit une mesure de l'écart entre la production observée et la production maximale réalisable. En d'autres, $TE_i$ détermine l'utilisation non efficiente des inputs.
